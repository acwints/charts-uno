...
SEED_SECRET = os.environ.get("SEED_SECRET", "epic-charts-seed-2024")

@app.post("/api/admin/seed-teams")
async def seed_demo_teams(
    secret: str = Query(...),
    db: Session = Depends(get_db),
):
    """Create demo teams with favicon logos. Remove after use."""
    ...
    if not owner:
        raise HTTPException(status_code=400, detail="No users found. Please log in first.")
